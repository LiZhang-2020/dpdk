...
/**
 * Rte_intr_handle setup helper.
 *
 * @param[in] intr_handle
 *   interrupt handle to be initialized.
 ...
 * @return
 *  - 0 on success.
 *  - < 0 on failure, with rte_errno set.
 */
int
mlx5_os_interrupt_handler_setup(struct rte_intr_handle *intr_handle,
...
/**
 * Rte_intr_handle unsetup helper.
 *
 * @param[in] intr_handle
 ...
 */
void
mlx5_os_interrupt_handler_unset(struct rte_intr_handle *intr_handle,
				rte_intr_callback_fn cb, void *cb_arg)
{
	if (!intr_handle)
		return;
